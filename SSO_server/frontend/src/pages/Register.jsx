  ...
  useEffect(() => {
    async function checkSessionAndAuthenticate() {
      ...
      if (now >= expiryTime) {
        ...
        // Xóa cookie hết hạn
        document.cookie =
          "browser_session=; Max-Age=0; path=/; secure; samesite=Lax";
        document.cookie =
          "browser_session_exp=; Max-Age=0; path=/; secure; samesite=Lax";
        return;
      }
      ...
      try {
        ...
        console.warn(
          "Auto-authentication failed. Clearing session and prompting manual login."
        );
        setGeneralError(
          "Session đã hết hạn hoặc không hợp lệ. Vui lòng đăng nhập lại."
        );
        document.cookie =
          "browser_session=; Max-Age=0; path=/; secure; samesite=Lax";
        document.cookie =
