...
def home_page():
    ...
    # Render file trong Lms/templates/Homepage.html
...
def sso_callback():
    ...
    if auth_code:
        # Giả lập xác thực thành công và lưu thông tin vào Session của LMS
        session['username'] = 'sinhvien' # Trong thực tế sẽ lấy từ ID Token
