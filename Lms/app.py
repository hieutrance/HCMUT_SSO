...
def sso_callback():
    ...
    if auth_code:
        ...
        print(f"ASSERTION: {client_assertion}")
        ...
        print(f"Auth respose: {response.json()} ")
        ...
        print(f"Auth respose : {userinfo_response.json()}")
        ...
        try:
            ...
            lms_token = secrets.token_urlsafe(32)
            ...
            """, (user_id, lms_token, access_token, refresh_token, expires_at))
